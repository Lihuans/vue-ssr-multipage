...
const clientConfigs = require("./webpack.client.config");
...
module.exports = function setupDevServer(moduleName, app, templatePath, cb) {
  ...
  clientConfig.entry.app = [
    "webpack-hot-middleware/client?path=/__webpack_hmr_" + moduleName,
    clientConfig.entry.app
  ];
  ...
  clientConfig.output.publicPath = `/${moduleName}/dist`;
